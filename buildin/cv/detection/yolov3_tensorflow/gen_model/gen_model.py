...
def get_network(args):
    ...
    yolov3_h = input_dim[0][1]
    yolov3_w = input_dim[0][2]
    network = append_yolov3_detect(
        network,
        args.conf_thres,
        args.iou_thres,
        args.max_det,
...
def get_args():
    ...
    arg_parser.add_argument(
        "--iou_thres", dest="iou_thres", type=float, default=0.45, help="nms_thresh"
    )
    arg_parser.add_argument(
        "--max_det", dest="max_det", type=int, default=1024, help="limit_detections"
    )
...
def main():
    ...
    tmp_flag = args.precision.find("qint")
