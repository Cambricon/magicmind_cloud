...
```bash
Generate model done, model save to yolov3_tensorflow/data/models/yolov3_tf_force_float32_false_1
```
...
| ------ | ------------------- | ---------- | -------------- | --------- | 
| Yolov3 | force_float32       | 1          | 0.336          | 0.567     |
| Yolov3 | force_float16       | 1          | 0.331          | 0.564     | 
| Yolov3 | qint8_mixed_float16 | 1          | 0.309          | 0.552     |
