...
def calibrate(args, network : mm.Network, config : mm.BuilderConfig):
    ...
    calib_data = CalibData(shape = mm.Dims([args.input_dims[0][0], args.input_dims[0][1], args.input_dims[0][2], args.input_dims[0][3]]), 
                           max_samples = max_samples, img_list = args.image_dir)
...
def get_args():
    ...
    arg_parser.add_argument(
        ...
        dest="image_dir",
        type=str,
        default="../../datasets/widerface/WIDER_val",
        help="widerface datasets",
    )
    arg_parser.add_argument(
        "--conf_thres",
        dest="conf_thres",
