...
# 若不存在则根据您的实际路径修改
#export WIDERFACE_DATASETS_PATH=
if [ -z ${WIDERFACE_DATASETS_PATH} ] || [ ! -d ${WIDERFACE_DATASETS_PATH} ];then
    echo "Error: WIDERFACE_DATASETS_PATH is not found, please set it and export it to env!"
fi
