...
# bash run.sh <precision> <shape_mutable> <save_img> <batch_size> 
bash run.sh qint8_mixed_float16 true true 10
```

使用 COCO API 计算精度:

```bash
export OUTPUT_DIR=$PROJ_ROOT_PATH/data/output/infer_cpp_output_qint8_mixed_float16_true_1
