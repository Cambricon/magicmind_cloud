...
python $MAGICMIND_CLOUD/test/compare_eval.py --metric cocomAP --output_file $PROJ_ROOT_PATH/data/images/infer_python_output_force_float32_true_1/log_eval --output_ok_file $PROJ_ROOT_PATH/data/images/infer_python_output_ok_force_float32_true_1/log_eval --model yolov5_v6_1_pytorch
