...
COMPUTE_COCO(){
    ...
    python $UTILS_PATH/compute_coco_mAP.py --file_list $DATASETS_PATH/file_list_5000.txt \
                                           --result_dir $PROJ_ROOT_PATH/data/output/infer_python_output_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH} \
                                           --ann_dir $DATASETS_PATH \
                                           --data_type val2017 \
                                           --json_name $PROJ_ROOT_PATH/data/json/yolov5_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH} \
                                           --image_num ${IMG_NUM} 2>&1 |tee $PROJ_ROOT_PATH/data/output/infer_python_output_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH}/log_eval
}
