...
def get_network(args):
    ...
    yolov5_h = input_dim[0][2]
    yolov5_w = input_dim[0][3]
    network = append_yolov5_detect(
        network, args.conf_thres, args.iou_thres, args.max_det, yolov5_h, yolov5_w
    )
    return network
...
def get_args():
    ...
    arg_parser.add_argument(
        "--max_det", dest="max_det", type=int, default=300, help="limit_detections"
    )
