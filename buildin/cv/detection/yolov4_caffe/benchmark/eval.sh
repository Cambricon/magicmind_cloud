  ...
  do
    ...
    do
      ...
      python $UTILS_PATH/compute_coco_mAP.py  --file_list  $UTILS_PATH/coco_file_list_5000.txt \
                                              ...
                                              --data_type val2017 \
                                              --json_name $PROJ_ROOT_PATH/data/output/yolov4_${precision}_${shape_mutable}_${batch} \
                                              --img_dir $DATASETS_PATH/val2017 \
                                              --image_num 5000 2>&1 | tee $PROJ_ROOT_PATH/data/output/yolov4_${precision}_${shape_mutable}_${batch}_log_eval
