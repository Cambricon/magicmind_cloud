...
# 若不存在则根据您的实际路径修改
#export TOTAL_TEXT_DATASETS_PATH=
if [ -z ${TOTAL_TEXT_DATASETS_PATH} ] || [ ! -d ${TOTAL_TEXT_DATASETS_PATH} ];then
    echo "Error: TOTAL_TEXT_DATASETS_PATH is not found, please set it and export it to env!"
fi
