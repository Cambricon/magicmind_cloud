...
export PROJ_ROOT_PATH=$MAGICMIND_CLOUD/buildin/cv/detection/dbnet_pytorch
#数据集和模型路径
export DATASETS_PATH=/nfsdata/modelzoo/datasets/total_text
export MODEL_PATH=$PROJ_ROOT_PATH/data/models
#cv类网络通用文件路径
export UTILS_PATH=$MAGICMIND_CLOUD/buildin/cv/utils
echo "check DATASETS_PATH before run this sample!!!"
