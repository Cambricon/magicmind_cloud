...
then
  ...
  python demo.py experiments/seg_detector/totaltext_resnet18_deform_thre.yaml --image_path ${DATASETS_PATH}/total_text/test_images/img1.jpg --resume $MODEL_PATH/totaltext_resnet18 --polygon --box_thresh 0.7 --visualize
