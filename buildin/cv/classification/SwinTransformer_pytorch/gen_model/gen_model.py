...
def main():
    ...
    args.add_argument("--onnx_model", "--onnx_model", type=str, default="../data/models/swin.onnx", help="original swin onnx")
    args.add_argument("--output_model", "--output_model", type=str, default="swin_onnx_model", help="save mm model to this path")
    ...
    print('build model...')
    builder = mm.Builder()
    model = builder.build_model('swin_onnx_model', network, config)
