...
def main():
    ...
    args.add_argument("--caffe_model", "--caffe_model", type=str, default="../data/models/vgg16.caffemodel", help="original vgg16 caffe_model")
    args.add_argument("--prototxt", "--prototxt", type=str, default="../data/models/deploy.prototxt", help="original vgg16 prototxt")
