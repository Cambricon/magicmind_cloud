...
then
    MAGICMIND_MODEL=$MODEL_PATH/vgg16_caffe_model_${PRECISION}_${SHAPE_MUTABLE}_${BATCH_SIZE}
else
    MAGICMIND_MODEL=$MODEL_PATH/vgg16_caffe_model_${PRECISION}_${SHAPE_MUTABLE}
fi
