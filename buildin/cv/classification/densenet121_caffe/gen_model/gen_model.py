...
def main():
    ...
    args.add_argument("--precision", "--precision", type=str, default="qint8_mixed_float16", help="qint8_mixed_float16, forced_float32, forced_float16")
    ...
    # supported_quant_mode = ['qint8_mixed_float16', 'force_float16', 'force_float32']
