...
BATCH_SIZE=$3
if [ ! -f $MODEL_PATH/squeezenet_v1_0_caffe_model_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH_SIZE} ];
then
    python gen_model.py  --caffe_model $MODEL_PATH/squeezenet_v1_0.caffemodel \
                         --prototxt $MODEL_PATH/deploy_v1_0.prototxt \
                         --output_model $MODEL_PATH/squeezenet_v1_0_caffe_model_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH_SIZE} \
    ...
    echo "mm_model: $MODEL_PATH/squeezenet_v1_0_caffe_model_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH_SIZE} already exist."
fi
