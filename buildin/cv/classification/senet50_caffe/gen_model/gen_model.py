...
def main():
    ...
    args.add_argument("--caffe_model", "--caffe_model", type=str, default="../data/models/senet50.caffemodel", help="original senet50 caffe_model")
    args.add_argument("--prototxt", "--prototxt", type=str, default="../data/models/deploy.prototxt", help="original senet50 prototxt")
    ...
    model = builder.build_model("senet50_caffe_model", network, config)
