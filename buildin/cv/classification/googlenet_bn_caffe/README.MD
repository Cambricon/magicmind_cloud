...
```bash
Generate model done, model save to /mm_ws/proj/modelzoo/magicmind_cloud/buildin/cv/classification/googlenet_bn_caffe/data/models/googlenet_bn_caffe_model_force_float32_true
```
...
| ------------ | ------------------- | ---------- | -------- | -------- | 
| googlenet_bn | force_float32       | 1          | 0.70388  | 0.89742  | 
| googlenet_bn | force_float16       | 1          | 0.70382  | 0.89748  |
| googlenet_bn | qint8_mixed_float16 | 1          | 0.69954  | 0.89516  |
