...
BATCH_SIZE=$3
if [ ! -f $MODEL_PATH/alexnet_bn_caffe_model_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH_SIZE} ];
then
    python gen_model.py  --caffe_model $MODEL_PATH/AlexNet_cvgj/alexnet_cvgj_iter_320000.caffemodel \
                         ...
                         --output_model $MODEL_PATH/alexnet_bn_caffe_model_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH_SIZE} \
    ...
    echo "mm_model: $MODEL_PATH/alexnet_bn_caffe_model_${QUANT_MODE}_${SHAPE_MUTABLE}_${BATCH_SIZE} already exist."
fi
