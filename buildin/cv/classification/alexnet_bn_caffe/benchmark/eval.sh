...
then 
	...
	cd $PROJ_ROOT_PATH/gen_model
        ...
        do
            ...
            python $MAGICMIND_CLOUD/test/compare_eval.py --metric top1andtop5 --output_file $PROJ_ROOT_PATH/data/output/infer_cpp_output_${quant_mode}_true_${batch}/eval_result.txt --output_ok_file $PROJ_ROOT_PATH/data/output_ok/infer_cpp_output_${quant_mode}_true_${batch}_eval_result.txt --model alexnet_bn_caffe
        done
    done
fi
