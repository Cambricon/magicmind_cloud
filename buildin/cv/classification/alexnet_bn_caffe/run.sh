...
python $MAGICMIND_CLOUD/test/compare_eval.py --metric top1andtop5 --output_file $PROJ_ROOT_PATH/data/output/infer_cpp_output_force_float32_true_1/eval_result.txt --output_ok_file $PROJ_ROOT_PATH/data/output_ok/infer_cpp_output_force_float32_true_1_eval_result.txt --model alexnet_bn_caffe
python $MAGICMIND_CLOUD/test/compare_perf.py --output_file $PROJ_ROOT_PATH/data/output/force_float32_true_1_log_perf --output_ok_file $PROJ_ROOT_PATH/data/output_ok/force_float32_true_1_log_perf --model alexnet_bn_caffe
