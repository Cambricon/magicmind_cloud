...
```bash
top1:  0.5805805805805806
top5:  0.7977977977977978
```
...
| ------- | ------------------- | ---------- | ------- | ------- |
| alexnet | force_float32       | 1          | 0.58776 | 0.8145  |
| alexnet | force_float16       | 1          | 0.58794 | 0.81446 |
| alexnet | qint8_mixed_float16 | 1          | 0.58148 | 0.8088  |
