...
do
  ...
  do
    ...
    do
      ...
      #compare
      python $MAGICMIND_CLOUD/test/compare_eval.py --metric top1andtop5 --output_file $PROJ_ROOT_PATH/data/output/${quant_mode}_${shape_mutable}_${batch}/eval_result.txt --output_ok_file $PROJ_ROOT_PATH/data/output_ok/${quant_mode}_${shape_mutable}_${batch}_eval_result.txt --model mobilenetv3_pytorch
    done
  done
done
