...
# 若不存在则根据您的实际路径修改
#export SYNTH_DATASETS_PATH=
if [ -z ${SYNTH_DATASETS_PATH} ] || [ ! -d ${SYNTH_DATASETS_PATH} ];then
    echo "Error: SYNTH_DATASETS_PATH is not found, please set it and export it to env!"
fi
