...
以上 3.3~3.5 的步骤也可以通过运行 `cd magicmind_cloud/buildin/cv/segmentation/deeplabv3_tf && bash run.sh` 来实现一键执行
...
| ------------ | ------------------- | ------------------ | ------ |
| deeplabv3_tf | force_float32       | true               | 0.7464 |
| deeplabv3_tf | force_float16       | true               | 0.7463 |
| deeplabv3_tf | qint8_mixed_float16 | true               | 0.7431 |
