...
# 若不存在则根据您的实际路径修改
#export VOC2012_DATASETS_PATH=
if [ -z ${VOC2012_DATASETS_PATH} ] || [ ! -d ${VOC2012_DATASETS_PATH} ];then
    echo "Error: VOC2012_DATASETS_PATH is not found, please set it and export it to env!"
fi
