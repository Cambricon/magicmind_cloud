...
# 若不存在则根据您的实际路径修改
#export CARVANA_DATASETS_PATH=
if [ -z ${CARVANA_DATASETS_PATH} ] || [ ! -d ${CARVANA_DATASETS_PATH} ];then
    echo "Error: CARVANA_DATASETS_PATH is not found, please set it and export it to env!"
fi
