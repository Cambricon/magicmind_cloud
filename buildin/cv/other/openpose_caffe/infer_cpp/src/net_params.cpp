...
DEFINE_string(network, "BODY_25",
              "network name, BODY_25 and COCO are supported.");
          ...
          NetParams(
              {25,  // nkeypoints, ignore background
               ...
               std::vector<int>({// indexes_in_coco_order
                                 0, 16, 15, 18, 17, 5, 2, 6, 3, 7, 4, 12, 9, 13,
                                 10, 14, 11})})),
      std::make_pair(
          "COCO",
          NetParams({18,  // nkeypoints, ignore background, one more keypoint
                          // than COCO dataset(neck)
                     19,  // nbody_part_pairs
                     57,  // nheatmaps
                     ...
                     std::vector<cv::Scalar>(
                         {// colors
                          ...
                          cv::Scalar(0, 255, 255), cv::Scalar(0, 170, 255),
                          cv::Scalar(0, 85, 255), cv::Scalar(0, 0, 255),
                          cv::Scalar(255, 0, 170), cv::Scalar(170, 0, 255),
                          cv::Scalar(255, 0, 255), cv::Scalar(85, 0, 255)}),
...
const std::string &GetNetName() { return FLAGS_network; }
