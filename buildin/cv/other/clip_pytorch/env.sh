...
# 若不存在则根据您的实际路径修改
#export CIFAR100_DATASETS_PATH=
if [ -z ${CIFAR100_DATASETS_PATH} ] || [ ! -d ${CIFAR100_DATASETS_PATH} ];then
    echo "Error: CIFAR100_DATASETS_PATH is not found, please set it and export it to env!"
fi
