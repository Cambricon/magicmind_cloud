...
本例使用的 clip 实现来自 github 开源项目https://github.com/openai/CLIP。 下面将展示如何将该项目中 onnx 实现的 clip 模型转换为 MagicMind 的模型。
...
```bash
Generate model done , model save to /data/mm_model/clip_onnx_force_float32_true
```
...
| --------- | ---------- | ---------- | --------- |
| clip | force_float32_true_32 | 0.617288| 0.867889 |
| clip | force_float16_true_32 | 0.333433| 0.649038 |
| clip | qint8_mixed_float16_true_32 | 0.297000| 0.543670 |
