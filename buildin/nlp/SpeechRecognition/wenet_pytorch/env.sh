### 在开始运行本仓库前先检查以下路径：
#数据集路径
#export AISHELL_DATASETS_PATH=
if [ -z ${AISHELL_DATASETS_PATH} ] || [ ! -d ${AISHELL_DATASETS_PATH} ];then
    echo "Error: AISHELL_DATASETS_PATH is not found, please set it and export it to env!"
fi
