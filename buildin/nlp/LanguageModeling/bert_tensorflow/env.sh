### 在开始运行本仓库前先检查以下路径：
#数据集路径
#export SQUAD_DATASETS_PATH=
if [ -z ${SQUAD_DATASETS_PATH} ] || [ ! -d ${SQUAD_DATASETS_PATH} ];then
    echo "Error: SQUAD_DATASETS_PATH is not found, please set it and export it to env!"
fi
