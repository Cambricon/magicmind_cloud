...
parser.add_argument("--magicmind_model", "--magicmind_model", type = str, default = "../data/models/bert_squad_pytorch_model")
...
parser.add_argument("--max_seq_length", "--max_seq_length", type = int, default = 384, help = "max_seq_length")
