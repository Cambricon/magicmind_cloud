...
def main():
    ...
    args.add_argument("--pt_model", "--pt_model", type=str, default="../data/models/bert_squad_pytorch.pt", help="bert_squad_pytorch pt")
    args.add_argument("--output_model", "--output_model", type=str, default="../data/models/bert_squad_pytorch_model", help="save mm model to this path")
