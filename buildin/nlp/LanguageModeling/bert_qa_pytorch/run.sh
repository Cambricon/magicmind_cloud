...
python $MAGICMIND_CLOUD/test/compare_eval.py --metric squad --output_file $PROJ_ROOT_PATH/data/output/infer_python_output_force_float16_true_1bs_128/acc_result.txt --output_ok_file $PROJ_ROOT_PATH/data/output_ok/infer_python_output_force_float16_true_1bs_128_acc_result.txt --model bert_qa_pytorch
