...
bash run.sh force_float16 1 4 16
```
...
bash run.sh force_float16 1 4 16 128
```

结果：

```bash
running: 100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 13/13 [00:05<00:00,  2.45it/s]
log_file:  /mm_ws/proj/modelzoo/magicmind_cloud/buildin/nlp/SpeechSynthesis/tacotron2_onnx/../../../../../magicmind_cloud/buildin/nlp/SpeechSynthesis/tacotron2_onnx/data/output/force_float16_1_4_16_128_log_perf
```
...
本 sample 通过一键运行 benchmark 里的脚本得到性能 benchmark 测试：
